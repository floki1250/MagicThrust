<template>
    <div class="flex justify-between items-center text-center  ">
        <div class="lg:w-1/2">
            <div>
                <h1 class="text-6xl text-left font-RaMono text-gray-600 dark:text-gray-50">Describe your data</h1>
                <br>
                <br>
                <div class="flex gap-4">
                    <div
                        class="   hover:shadow-xl hover:bg-gradient-to-tr from-[#ceb2ce] to-[#467fff] w-full p-0.5 rounded-full transition-all duration-500 ease-in-out text-gray-400 hover:text-gray-700 hover:dark:text-white">
                        <div class="p-2 flex gap-2 bg-gray-50 min-w-96 w-full rounded-full  dark:bg-gray-800">
                            ...
                            <input type="text" placeholder="Describe your data..."
                    ...
                    <div
                        class="hover:bg-gradient-to-r from-[#ceb2ce] to-[#467fff] border-1 border-gray-100 w-fit p-0.5 rounded-full  transition-all duration-500 ease-in-out">
                        <div
            ...
            <div
                class="flex gap-2 w-fit rounded-full bg-gray-50 dark:bg-gray-800  font-semibold text-gray-400 hover:text-amber-500 border-2 border-gray-50 dark:border-gray-900 dark:hover:border-amber-500 hover:border-amber-500  px-4 py-2  whitespace-nowrap transition-all duration-500 ease-in-out group">
